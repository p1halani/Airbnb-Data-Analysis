...
class DataPreprocess:
    def __init__(self, df, categorical_features, encoding_type, handle_na=False, drop_columns=[]):
        """
        df: pandas dataframe
    ...
    def transform(self, dataframe, drop_col):
        for c in drop_col:
...
if __name__ == "__main__":
    ...
    cat_feats = DataPreprocess(full_data, 
